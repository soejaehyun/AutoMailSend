...
class naver_mail_send(app_conf):
    def __init__(self, app, file_path, logger):
        super().__init__(app, file_path, logger)

        # 필요한 계정, 메일 내용 정보 저장
        '''
        self.uri = 'https://www.naver.com'
        self.account = {
            "id" : 'seojaehyun12',
            "pwd" : 'ghswjfrkt12'
        }
        self.recv = {
            "to" : [ "seojaehyun2@nate.com", "seojaehyun12@naver.com", "wogus123001@gmail.com" ],
            "cc" : [ "seojaehyun2@nate.com", "seojaehyun12@naver.com", "wogus123001@gmail.com" ],
            "bcc" : [ "seojaehyun2@nate.com", "seojaehyun12@naver.com", "wogus123001@gmail.com" ],
        }
        self.body = {
            "subject" : "테스트 메일 쓰기 !!",
            "content" : "본문!!",
        ...
        self.mailXpath = '//*[@id="NM_FAVORITE"]/div[1]/ul[1]/li[1]/a'
